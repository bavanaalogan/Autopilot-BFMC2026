...
from src.vision.ObjectDetection.threads.threadObjectDetection import threadObjectDetection
...
class processObjectDetection(WorkerProcess):
    ...
    def __init__(self, queueList, logging, ready_event=None, debugging=False):
        ...
        super(processObjectDetection, self).__init__(self.queuesList, ready_event)
